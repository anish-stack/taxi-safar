...
export default function LoginScreen({ navigation }) {
  ...
  const handleGetOtp = async () => {
    ...
    try {
      setLoading(true);
      const res = await axios.post(`${API_URL_APP}/api/v1/login`, {
        number: mobile,
      });
  ...
  const handleResendOtp = async () => {
    ...
    try {
      setLoading(true);
      const res = await axios.post(`${API_URL_APP}/api/v1/resend-otp`, {
        number: mobile,
      });
        ...
        >
          ...
          {!showOtpScreen ? (
            <>
              ...
              <View
                style={[styles.inputWrapper, mobileError && styles.inputError]}
              >
  ...
  returnKeyType="done" 
            ...
            <>
              ...
              {/* OTP Input */}
              <View
                style={[styles.otpContainer, otpError && styles.inputError]}
              >
                <TextInput
              ...
              >
                <Text
                  style={[
                    styles.resendText,
                    timer > 0 && { color: Colors.textSecondary },
                  ]}
                >
                  {timer > 0
                    ? `Resend in ${timer}s`
