...
vehicleSchema.virtual('expiring_soon').get(function() {
    ...
    return {
        insurance: this.insurance.expiry_date && this.insurance.expiry_date <= thirtyDaysFromNow,
        permit: this.permit.expiry_date && this.permit.expiry_date <= thirtyDaysFromNow,
        pucc: this.pucc_details.pucc_upto && this.pucc_details.pucc_upto <= thirtyDaysFromNow,
        tax: this.tax_details.tax_upto && this.tax_details.tax_upto <= thirtyDaysFromNow
    };
});
...
vehicleSchema.methods.getExpiryStatus = function() {
    ...
    return {
        ...
        pucc: {
            expired: this.pucc_details.pucc_upto && this.pucc_details.pucc_upto < today,
            expiring_soon: this.pucc_details.pucc_upto && this.pucc_details.pucc_upto <= thirtyDays,
            date: this.pucc_details.pucc_upto
        },
        tax: {
            expired: this.tax_details.tax_upto && this.tax_details.tax_upto < today,
            expiring_soon: this.tax_details.tax_upto && this.tax_details.tax_upto <= thirtyDays,
